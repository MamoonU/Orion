...
extern uint8_t kernel_start;			// from linker
extern uint8_t kernel_end;				// from linker
...
void kernel_main(uint32_t multiboot_magic, multiboot_info_t *mbi) {				//Kernel main function
	
	terminal_initialize();
	serial_init();

	serial_write("UART I/O: Online\n");
